            ...
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{ route ('admin.package_tours.update', $packageTour) }}" enctype="multipart/form-data">
                    ...
                    <div class="mt-4">
                        ...
                        <textarea name="about" id="about" cols="30" rows="5" class="border border-slate-300 rounded-xl w-full">{{ $packageTour->name }}</textarea>
                    ...
                    <hr class="my-5">
                        @forelse ($latestPhotos as $photo)
                            <div class="mt-4">
                                <x-input-label for="photo" :value="__('photo gallery')" />
