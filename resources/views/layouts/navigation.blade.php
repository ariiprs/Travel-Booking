        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.package_tours.index')" :active="request()->routeIs('admin_package_tours.index')">
                        {{ __('Package Tours') }}
                    </x-nav-link>
                    <x-nav-link :href="route('admin.package_bookings.index')" :active="request()->routeIs('admin_package_bookings.index')">
                        {{ __('Package bookings') }}
                    </x-nav-link>
                    @endrole
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">
              ...
              @role('customer')
                    ...
                    <x-responsive-nav-link :href="route('admin.package_tours.index')" :active="request()->routeIs('admin_package_tours.index')">
                        {{ __('Package Tours') }}
                    </x-responsive-nav-link>
                    <x-responsive-nav-link :href="route('admin.package_bookings.index')" :active="request()->routeIs('admin_package_bookings.index')">
                        {{ __('Package bookings') }}
                    </x-responsive-nav-link>
                    @endrole
        </div>
